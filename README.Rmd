...
This package serves as a frontend to the GDAL command-line utilities. Function arguments, descriptions, and much of the embedded documentation within `gdalcli` are derived directly from the official GDAL documentation.

We gratefully acknowledge the GDAL/OGR development team and contributors.
