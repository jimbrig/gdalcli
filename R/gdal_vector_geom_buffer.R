...
#' 
#' See
#' \url{https://gdal.org/en/release-3.11/programs/gdal_vector_geom_buffer.html}
...
#' not specified, all)
#' @param endcap_style Endcap style.. Choices: "round", "flat", "square" (Default:
#' `round`)
#' @param join_style Join style.. Choices: "round", "mitre", "bevel" (Default: `round`)
#' @param mitre_limit Mitre ratio limit (only affects mitered join style). (Default:
#' `5`). Minimum: `0`
#' @param quadrant_segments Number of line segments used to approximate a quarter
#' circle. (Integer) (Default: `8`). Minimum: `1`
#' @param side Sets whether the computed buffer should be single-sided or not..
...
#' https://gdal.org/programs/gdal-vector-geom-buffer.html
