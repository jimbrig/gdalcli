...
#' @title invdistnn: Create a regular grid from scattered points using weighted inverse
#' distance...
#' @description
...
#' 
#' See
#' \url{https://gdal.org/en/release-3.11/programs/gdal_vector_grid_invdistnn.html}
...
#' https://gdal.org/programs/gdal-vector-grid-invdistnn.html
