...
#' @title average-distance-points: Create a regular grid from scattered points using
...
#' 
#' See
#' \url{https://gdal.org/en/release-3.11/programs/gdal_vector_grid_average-distance-points.html}
...
#' https://gdal.org/programs/gdal-vector-grid-average-distance-points.html
