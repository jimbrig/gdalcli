...
#' @title average-distance: Create a regular grid from scattered points using the
...
#' 
#' See
#' \url{https://gdal.org/en/release-3.11/programs/gdal_vector_grid_average-distance.html}
...
#' https://gdal.org/programs/gdal-vector-grid-average-distance.html
