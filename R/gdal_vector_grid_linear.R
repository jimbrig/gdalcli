...
#' @title linear: Create a regular grid from scattered points using
#' linear/barycentric...
#' @description
...
#' 
#' See
#' \url{https://gdal.org/en/release-3.11/programs/gdal_vector_grid_linear.html}
...
#' https://gdal.org/programs/gdal-vector-grid-linear.html
