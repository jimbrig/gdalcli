...
#' @title minimum: Create a regular grid from scattered points using the minimum value
#' in the...
#' @description
...
#' 
#' See
#' \url{https://gdal.org/en/release-3.11/programs/gdal_vector_grid_minimum.html}
...
#' https://gdal.org/programs/gdal-vector-grid-minimum.html
