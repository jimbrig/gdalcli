...
#' @title maximum: Create a regular grid from scattered points using the maximum value
#' in the...
#' @description
...
#' 
#' See
#' \url{https://gdal.org/en/release-3.11/programs/gdal_vector_grid_maximum.html}
...
#' https://gdal.org/programs/gdal-vector-grid-maximum.html
