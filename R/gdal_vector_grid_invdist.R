...
#' @title invdist: Create a regular grid from scattered points using weighted inverse
#' distance...
#' @description
...
#' 
#' See
#' \url{https://gdal.org/en/release-3.11/programs/gdal_vector_grid_invdist.html}
...
#' @param max_points Maximum number of data points to use (Integer) (Default:
#' `2147483647`)
...
#' https://gdal.org/programs/gdal-vector-grid-invdist.html
