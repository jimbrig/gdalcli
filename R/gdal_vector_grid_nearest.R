...
#' @title nearest: Create a regular grid from scattered points using nearest neighbor
#' interpolation
#' @description
...
#' 
#' See
#' \url{https://gdal.org/en/release-3.11/programs/gdal_vector_grid_nearest.html}
...
#' https://gdal.org/programs/gdal-vector-grid-nearest.html
